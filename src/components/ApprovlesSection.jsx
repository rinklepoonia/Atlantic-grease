    ...
    return (
        <div id='testimonials' className='position-relative pb_lg_78 pb_10 pt-xl-0 pt-lg-4'>
            ...
            <div className='max_w_1140 custom_container'>
                <h3 className='ff_pop fw-800 text_52xl lh_62 color_white text-uppercase mb_lg_53 mb_20'>OEM  <span className='fw-normal style_italic bg_blue d-inline-block transform_skew p-2'>Approvals</span></h3>
            </div>
            <div className='custom_container'>
                <div className="row flex-xl-row flex-column-reverse">
                    ...
                    <div className="col-xl-4 col-12 d-flex justify_content_center">
