    ...
    return (
        <div id='about' className='circle_bg_img bg_no_repeat circle_bg_cover bg_pos_center position-relative h_lg_1344 h_950 h_788'>
            <div className='d-lg-block d-none'>
                <div data-aos="zoom-in" className='position-absolute posi_circle_1'>
                    <div className='IconBox d-flex justify-content-center align-items-center circle_borderRadius'>
                        <img src={Wimg} alt="Wimg" />
                    </div>
                </div>
                <div data-aos="zoom-in" className='position-absolute posi_circle_2'>
                    <div className='IconBox d-flex justify-content-center align-items-center circle_borderRadius'>
                        <img src={Wimg} alt="Wimg" />
                    </div>
                </div>
                <div data-aos="zoom-in" className='position-absolute posi_circle_3'>
                    <div className='IconBox d-flex justify-content-center align-items-center circle_borderRadius'>
                        <img src={miniImg} alt="miniImg" />
                    </div>
                </div>
                <div data-aos="zoom-in" className='position-absolute posi_circle_4'>
                    <div className='IconBox d-flex justify-content-center align-items-center circle_borderRadius'>
                        <img src={CatImg} alt="CatImg" />
                    </div>
                </div>
                <div data-aos="zoom-in" className='position-absolute posi_circle_5weapn'>
                    <div className='IconBox d-flex justify-content-center align-items-center circle_borderRadius'>
                        <img src={NinjaWeapn} alt="NinjaWeapn" />
                    </div>
                </div>
                <div data-aos="zoom-in" className='position-absolute posi_circle_6mini'>
                    <div className='IconBox d-flex justify-content-center align-items-center circle_borderRadius'>
                        <img src={miniImg} alt="miniImg" />
                    </div>
                </div>
                <div data-aos="zoom-in" className='position-absolute posi_circle_7wimg'>
                    <div className='IconBox d-flex justify-content-center align-items-center circle_borderRadius'>
                        <img src={Wimg} alt="Wimg" />
                    </div>
                </div>
            </div>
            <div data-aos="zoom-in" className='d-lg-none d-block'>
            ...
            <div className='tranform_text'>
                <div className='d-flex justify-content-center'>
                    <h5 data-aos="fade-down" className='max_w_264 ff_pop fw-800 text_52xl lh_62 color_white max_w_578 text-center mb_lg_75 mb_30 text-uppercase'>Our <span href="" className='bttn ff_pop fw-normal style_italic ff_pop fw-800 text_52xl lh_62 color_white transform_skew d-inline-block px-2'><span>Numbers</span></span> Say About Us</h5>
                </div>
                <div className="max_w_1140 custom_container">
                    <div className="row">
                        <div data-aos="fade-up" className="col-lg-3 col-6">
            ...
            <div className='circleSection_grident position-absolute position_grident_circle d-lg-block d-none'></div>
        </div>
    )
}
