...
function ManufactorsSection() {
    return (
        <div id='services' className='py_xl_184_210 py_sm_90 py_40 position-relative'>
            <div className='manufactore_grident pos_grident_manufactor position-absolute d-sm-block d-none'></div>
            <div className='container'>
                <div className='d-flex justify-content-xl-end justify_content_center'>
                    <h2 className='ff_pop fw-800 text_52xl lh_lg_52 lh_sm_45 lh_36 color_white max_w_745 text-uppercase'>Pioneers of <span className='ff_pop fw-800 text_52xl lh_lg_52 lh_sm_45 lh_36 color_white style_italic fw-normal bg_red d-inline-block transform_skew p-md-2 p-1 bttn'><span> Lubricants </span></span>
            ...
            <div className='mx-auto'>
                <div className="row justify-content-center">
                    ...
                    <div className="col-xl-7 white_bg bg_img_cover mt-xl-5 mt-0 py_lg_20 py_xl_68 py_sm_30 py_10 h_417">
                        ...
                        <div className='justify_content_center d-flex'>
                            <button className='ff_chivo fw-900 text_16xs lh_24 color_white ml_127 max_w_184 text-uppercase comn_btn text-nowrap position-relative z-1'>read our story</button>
                        </div>
                    </div>
                </div>
            </div>
